          ...
          <div className="flex-1 max-w-3xl">
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-8">
                ...
                <div>
                  ...
                  <div className="text-blue-300 text-sm font-medium">
                    Solutions d'envoi vers le Burkina Faso
                  </div>
                </div>
              </div>
              ...
              <p className="text-xl text-white/80 mb-8 leading-relaxed">
                Depuis 8 ans, nous proposons des solutions sur mesure pour tous
                vos envois vers le Burkina Faso. Du simple colis aux objets
                volumineux, nous avons le service adapté.
              </p>
              ...
              <div className="mt-8 flex flex-col sm:flex-row gap-4 text-sm">
                <div className="flex items-center gap-2 text-white/70">
                  ...
                  <span className="font-medium">
                    🇫🇷 Conseils gratuits: +33 6 70 69 98 23
                  </span>
                </div>
                <div className="flex items-center gap-2 text-white/70">
                  <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
                  <span className="font-medium">
                    🇧🇫 Suivi colis: +226 76 60 19 81
                  </span>
                </div>
              </div>
            </div>
